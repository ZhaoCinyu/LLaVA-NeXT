...
def flash_mixture_self_extend_forward(
    ...
    **kwargs,
    ...
    if q_len == 1:
        ...
        normal_query_states, normal_key_states = apply_rotary_pos_emb(query_states, key_states, cos, sin)
        ...
        # normal_query_states = repeat_kv(normal_query_states, self.num_key_value_groups).transpose(1, 2).contiguous()
    ...
    if normal_attn_output is not None:
        ...
        normal_attn_mask[:, :, :self.num_heads//2, :] = True
