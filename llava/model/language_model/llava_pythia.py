...
from transformers import GPTNeoXConfig, GPTNeoXModel, GPTNeoXForCausalLM

# from .Pythia.modeling_Pythia import PythiaLMHeadModel, PythiaModel
# from .Pythia.configuration_Pythia import PythiaConfig
...
class LlavaPythiaForCausalLM(GPTNeoXForCausalLM, LlavaMetaForCausalLM):
    config_class = LlavaPythiaConfig

    def __init__(self, config):
        # super(GPTNeoXForCausalLM, self).__init__(config)
        GPTNeoXForCausalLM.__init__(self, config)
        config.model_type = "llava_pythia"
